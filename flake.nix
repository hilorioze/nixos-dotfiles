{
  nixConfig = {
    ...
    extra-substituters = [
      ...
      "https://cache.garnix.io?priority=42"
    ...
    extra-trusted-public-keys = [
      "attic.hilorioze.com-hilorioze-1:vKKWGjVDgXl/TXbUWuPWTnDhhDit6hqkTcuoGfter5Y="
  ...
  inputs = {
    ...
    nix-vscode-extensions.url = "github:nix-community/nix-vscode-extensions"; # keep their pinned inputs
