{
  ...
  src = fetchFromGitHub {
    ...
    rev = "ce3c45d580257185623e8330bca9aeb85caed8ad";
    hash = "sha256-W4gGLz+5yzDdM7gyimV1LNXXcGZIgw62f6jQJAj+MgA=";
  };
  ...
  rustDep = rustPlatform.buildRustPackage {
    ...
    cargoHash = "sha256-TGsnevAIWOIP07W4hEk+Kne+deuvRSj2+2EuU2qY87w=";
