{
  ...
  src = fetchFromGitHub {
    ...
    rev = "7bbc8e5fd3eb1bf2a02a2259e51080fcf1a85538";
    hash = "sha256-xrTawwdxdQHTi7bLtXyHu/fa0jFA3huP4ZR3NOgy+S8=";
  };
  ...
  rustDep = rustPlatform.buildRustPackage {
    ...
    cargoHash = "sha256-uoWZS30iV2R7xm2WWq46u1L8cqPctVz+MLA5GBHuzvY=";
